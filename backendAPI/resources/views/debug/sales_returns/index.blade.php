    ...
    <script>
        (() => {
                    ...
                    tbody.insertAdjacentHTML('beforeend', `
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a class="btn btn-sm btn-outline-secondary ${canDanger ? '' : 'disabled'}" ${canDanger ? `href="{{ url('/debug/sales-returns') }}/${r.id}/edit"` : 'href="#" aria-disabled="true" tabindex="-1"'}>Edit</a>
            ...
            tbody.addEventListener('click', async (e) => {
                ...
                if (!confirm(`Void sales return #${id}?`)) return;

                const r = await window.DebugApi.apiFetch(`/api/sales-returns/${id}/void`, {
                    method: 'POST',
                ...
                window.DebugApi.showAlert('success', 'Sales return voided');
                load().catch(() => {});
            });
