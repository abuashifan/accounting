...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h1 class="h4 m-0">Create Sales Return</h1>
    ...
    <div class="card">
        <div class="card-body">
            <div class="alert alert-info small">
                Retur penjualan membuat jurnal <code>Pendapatan(D) - Piutang(C)</code> dan stok bertambah saat posting.
                Invoice sumber harus sudah <code>posted</code>.
            </div>
            ...
            <form id="form">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="form-label" for="invoice_id">Invoice (posted)</label>
                        <select class="form-select form-select-sm" id="invoice_id" required></select>
                    </div>
                    <div class="col-12">
    ...
    <script>
        (() => {
            ...
            async function loadInvoices() {
                const res = await window.DebugApi.apiFetch('/api/invoices?per_page=50');
            ...
            document.getElementById('form').addEventListener('submit', async (e) => {
                ...
                const payload = {
                    ...
                    invoice_id: Number(invoiceSelect.value || 0),
                ...
                const res = await window.DebugApi.apiFetch('/api/sales-returns', {
                    method: 'POST',
                ...
                window.DebugApi.showAlert('success', 'Sales return created');
            ...
            Promise.all([loadInvoices(), loadItems(), loadWarehouses()]).then(() => recalcTotal()).catch(() => {});
        })();
    </script>
@endpush
