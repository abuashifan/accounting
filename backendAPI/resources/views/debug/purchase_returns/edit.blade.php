...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <h1 class="h4 m-0">Edit Purchase Return #{{ $id }}</h1>
        ...
        <div class="card-body">
            ...
            <form id="form">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <label class="form-label" for="invoice_label">Purchase Invoice</label>
                ...
                <div class="mt-3 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary btn-sm" href="{{ route('debug.purchase-returns.index') }}">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        (() => {
            ...
            async function loadReturn() {
                const res = await window.DebugApi.apiFetch(`/api/purchase-returns/${returnId}`);
                const payload = await res.json().catch(() => null);
                ...
                const line = (r.purchase_return_lines || [])[0] || null;
                if (line) {
            ...
            document.getElementById('form').addEventListener('submit', async (e) => {
                ...
                window.DebugApi.showAlert('success', 'Purchase return updated');
